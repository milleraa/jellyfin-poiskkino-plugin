...
2. Выполни процедуру **целиком** по навыку `@.opencode/skills/pr-mr-rework/SKILL.md`: зафиксируй feedback в `status.md` (секция **PR/MR feedback / rework**), стадия `rework`, owner `Orchestrator`, переключись на **существующую** ветку (новую не создавай), маршрутизируй доработку нужной роли (Аналитик / Архитектор / Техлид / DevOps через Техлида / QA).
