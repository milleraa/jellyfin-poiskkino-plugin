    ...
    ILogger<PoiskKinoSeriesProvider> logger) : IRemoteMetadataProvider<Series, SeriesInfo>, IHasOrder
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            // Локальная фильтрация по году (ADR-0001): попадание в releaseYears или совпадение с Year
            series = SearchYearFilter.Apply(series, searchInfo.Year, SearchYearFilter.MatchesSeries, _logger);
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            Models.PoiskKinoMovieDto? seriesData = null;
            ...
            if (seriesData != null && seriesData.Rating != null)
            {
                ...
                if (seriesData.Rating.Kp.HasValue)
                {
                    result.Item.CriticRating = (float)seriesData.Rating.Kp.Value;
                }
            }
